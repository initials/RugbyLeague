...
namespace RugbyLeague
{
    class Team : FlxGroup
    {
        ...
        public Player getNextPlayerToLeft(bool AlsoSelect)
        {
            ...
            for (int i = 0; i < this.members.Count; i++)
            {
                if (((Player)this.members[i]).isSelected == true)
                {
                    ...
                    else
                    {
                        ...
                        return ((Player)this.members[i + 1]);
        ...
        public Player getNextPlayerToRight(bool AlsoSelect)
        {
            members.Sort((x, y) => x.x.CompareTo(y.x));
            ...
            for (int i = 0; i < this.members.Count; i++)
            {
                if (((Player)this.members[i]).isSelected == true)
                {
                    ...
                    if (i == 0)
                    {
                        ...
                        return ((Player)this.members[this.members.Count - 1]);
